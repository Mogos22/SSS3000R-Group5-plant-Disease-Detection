...
class tomato:
    def __init__(self, image_path, text_to_speech_func):
        ...
        self.model = tf.keras.models.load_model('/home/mogos/models/TomatoModel.h5' , compile=False)

        #definere ekiketter for tomatskdom
        #input_img = preprocess_image(images_path) Two-spotted_spider_mite
        #if input_img is not None:
        self.class_labels = ["Tomato_Bacterial_spot", "Tomato_Early_blight", "Tomato_healthy",
...
if __name__ == "__main__":
    ...
    image_path = "/home/mogos/SSS3000R-Group5-plant-Disease-Detection/image/tomato/Tomato_Early_blight/0a2726e0-3358-4a46-b6dc-563a5a9f2bdf___RS_Erly.B 7860.JPG"

    #initialser tomato-klassen med bildbanen og tekst-til-tale funsjonen. 
    detector = tomato(image_path, text_to_speech_func)
